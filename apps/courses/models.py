...
class Course(models.Model):
    ...
    category = models.CharField(default=u"数学",max_length=20, verbose_name=u"课程类别")
    ...
    def go_to(self):
        ...
        return mark_safe("<a href='https://atcumt.cn'>跳转</a>")
...
class CourseResource(models.Model):
    courses = models.ForeignKey(Course, on_delete=models.CASCADE, verbose_name=u"课程")
